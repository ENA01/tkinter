...
# GET THE USER INPUT AND PLACE IT IN TEXTFIELD
i=0
...
Button(root,text="EXPO",command=lambda:get_operation("**")).grid(row= 4,column= 4)
...
Button(root,text="DEL",command=lambda:undo()).grid(row= 5,column= 5)
